...
export default function GroupChatsIndexPage() {
  ...
  const { data: groupChats, isLoading: chatsLoading } =
  ...
  return (
    <div className="horizon-bg relative min-h-screen">
      <main className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-6 py-12">
        <Card className="rounded-2xl border border-white/40 bg-white/80 shadow-xl backdrop-blur-sm dark:border-slate-700 dark:bg-slate-900/40">
          <CardHeader className="flex flex-col items-start justify-between gap-4 pb-4 md:flex-row md:items-center">
            ...
            <div>
              <CardTitle className="text-3xl font-black tracking-tight text-[#0A2A43] md:text-4xl">
                Group Chats
              </CardTitle>
              <p className="mt-2 max-w-xl text-sm text-gray-600 md:text-base dark:text-gray-200">
                Start a new group or jump back into conversations with your
                travel crew.
              </p>
            </div>
            ...
            <Button
              variant="default"
              className="h-auto rounded-xl bg-[#0A2A43] px-5 py-3 font-semibold text-white shadow-md transition hover:bg-[#061829]"
              ...
              <div className="space-y-2">
                {groupChats.map((chat) => (
                  <Link
                    ...
                    className="block"
                  >
                    <div className="flex items-center justify-between rounded-xl border border-slate-200 bg-white/70 px-3 py-2 transition hover:bg-[#0A2A43]/5 dark:border-slate-700 dark:bg-slate-900/70 dark:hover:bg-slate-800/80">
